                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSection(
                      title: 'Ù…Ù‚Ø¯Ù…Ø©',
                      content: '''
Ù†Ø­Ù† ÙÙŠ Mbuy Ù†Ø­ØªØ±Ù… Ø®ØµÙˆØµÙŠØªÙƒ ÙˆÙ†Ù„ØªØ²Ù… Ø¨Ø­Ù…Ø§ÙŠØ© Ø¨ÙŠØ§Ù†Ø§ØªÙƒ Ø§Ù„Ø´Ø®ØµÙŠØ©. ØªÙˆØ¶Ø­ سياسة الخصوصية Ù‡Ø°Ù‡ ÙƒÙŠÙÙŠØ© Ø¬Ù…Ø¹ ÙˆØ§Ø³ØªØ®Ø¯Ø§Ù… ÙˆØ­Ù…Ø§ÙŠØ© Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„ØªÙŠ ØªÙ‚Ø¯Ù…Ù‡Ø§ Ù„Ù†Ø§ Ø¹Ù†Ø¯ Ø§Ø³ØªØ®Ø¯Ø§Ù… ØªØ·Ø¨ÙŠÙ‚Ù†Ø§.
...
â€¢ **Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„Ø­Ø³Ø§Ø¨:** Ø§Ù„Ø§Ø³Ù…ØŒ البريد الإلكترونيØŒ رقم الهاتف
â€¢ **Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„Ù…ØªØ¬Ø±:** Ø§Ø³Ù… Ø§Ù„Ù…ØªØ¬Ø±ØŒ Ø§Ù„ÙˆØµÙØŒ Ø§Ù„Ø´Ø¹Ø§Ø±ØŒ المنتجات
â€¢ **Ø¨ÙŠØ§Ù†Ø§Øª Ø§Ù„Ù…Ø¹Ø§Ù…Ù„Ø§Øª:** Ø³Ø¬Ù„ Ø§Ù„طلبØ§ØªØŒ المبيعاتØŒ Ø§Ù„Ù…Ø¯ÙÙˆØ¹Ø§Øª
...
''',
                    ...
                    _buildSection(
                      ...
                      content: '''
Ù†Ø³ØªØ®Ø¯Ù… Ø§Ù„Ù…Ø¹Ù„ÙˆÙ…Ø§Øª Ø§Ù„Ù…Ø¬Ù…Ø¹Ø© Ù„Ù„Ø£ØºØ±Ø§Ø¶ التاليØ©:

â€¢ ØªÙ‚Ø¯ÙŠÙ… Ø®Ø¯Ù…Ø§Øª Ø§Ù„ØªØ·Ø¨ÙŠÙ‚ ÙˆØªØ­Ø³ÙŠÙ†Ù‡Ø§
â€¢ Ù…Ø¹Ø§Ù„Ø¬Ø© Ø§Ù„طلبØ§Øª ÙˆØ§Ù„Ù…Ø¹Ø§Ù…Ù„Ø§Øª
...
â€¢ Ø§Ù„Ø§Ù…ØªØ«Ø§Ù„ Ù„Ù„Ù…ØªطلبØ§Øª Ø§Ù„Ù‚Ø§Ù†ÙˆÙ†ÙŠØ©
''',
                    ),
                    ...
                    _buildSection(
                      ...
                      content: '''
Ù„Ø§ Ù†Ø¨ÙŠØ¹ Ø£Ùˆ Ù†Ø¤Ø¬Ø± Ù…Ø¹Ù„ÙˆÙ…Ø§ØªÙƒ Ø§Ù„Ø´Ø®ØµÙŠØ© Ù„Ø£Ø·Ø±Ø§Ù Ø«Ø§Ù„Ø«Ø©. Ù‚Ø¯ Ù†Ø´Ø§Ø±Ùƒ Ù…Ø¹Ù„ÙˆÙ…Ø§ØªÙƒ ÙÙŠ Ø§Ù„Ø­Ø§Ù„Ø§Øª التاليØ©:

â€¢ **Ù…Ø¹ Ù…Ø²ÙˆØ¯ÙŠ Ø§Ù„Ø®Ø¯Ù…Ø©:** Ø´Ø±ÙƒØ§Øª Ø§Ù„Ø¯ÙØ¹ØŒ Ø®Ø¯Ù…Ø§Øª Ø§Ù„ØªÙˆØµÙŠÙ„
â€¢ **Ù„Ù„Ø§Ù…ØªØ«Ø§Ù„ Ø§Ù„Ù‚Ø§Ù†ÙˆÙ†ÙŠ:** Ø¹Ù†Ø¯ طلب Ø§Ù„Ø³Ù„Ø·Ø§Øª Ø§Ù„Ù…Ø®ØªØµØ©
...
''',
                    ...
                    _buildSection(
                      title: 'Ø­Ù‚ÙˆÙ‚Ùƒ',
                      content: '''
Ù„Ø¯ÙŠÙƒ Ø§Ù„Ø­Ù‚ÙˆÙ‚ التاليØ© Ø¨Ø®ØµÙˆØµ Ø¨ÙŠØ§Ù†Ø§ØªÙƒ:

â€¢ **Ø§Ù„ÙˆØµÙˆÙ„:** طلب Ù†Ø³Ø®Ø© Ù…Ù† Ø¨ÙŠØ§Ù†Ø§ØªÙƒ Ø§Ù„Ø´Ø®ØµÙŠØ©
â€¢ **Ø§Ù„ØªØµØ­ÙŠØ­:** ØªØ¹Ø¯ÙŠÙ„ Ø£ÙŠ Ù…Ø¹Ù„ÙˆÙ…Ø§Øª ØºÙŠØ± ØµØ­ÙŠØ­Ø©
â€¢ **Ø§Ù„Ø­Ø°Ù:** طلب Ø­Ø°Ù Ø¨ÙŠØ§Ù†Ø§ØªÙƒ (Ù…Ø¹ Ø¨Ø¹Ø¶ Ø§Ù„Ø§Ø³ØªØ«Ù†Ø§Ø¡Ø§Øª)
â€¢ **Ø§Ù„Ø§Ø¹ØªØ±Ø§Ø¶:** Ø§Ù„Ø§Ø¹ØªØ±Ø§Ø¶ Ø¹Ù„Ù‰ Ù…Ø¹Ø§Ù„Ø¬Ø© Ø¨ÙŠØ§Ù†Ø§ØªÙƒ
â€¢ **Ù†Ù‚Ù„ Ø§Ù„Ø¨ÙŠØ§Ù†Ø§Øª:** طلب Ù†Ù‚Ù„ Ø¨ÙŠØ§Ù†Ø§ØªÙƒ Ù„Ù…Ù†ØµØ© Ø£Ø®Ø±Ù‰
''',
                    ),
...
''',
                    ...
                    _buildSection(
                      ...
                      content: '''
Ù‚Ø¯ Ù†Ù‚ÙˆÙ… Ø¨تحديث سياسة الخصوصية Ù…Ù† ÙˆÙ‚Øª Ù„Ø¢Ø®Ø±. Ø³Ù†Ù‚ÙˆÙ… Ø¨Ø¥Ø¹Ù„Ø§Ù…Ùƒ Ø¨Ø£ÙŠ ØªØºÙŠÙŠØ±Ø§Øª Ø¬ÙˆÙ‡Ø±ÙŠØ© Ø¹Ø¨Ø±:

â€¢ Ø¥Ø´Ø¹Ø§Ø± Ø¯Ø§Ø®Ù„ Ø§Ù„ØªØ·Ø¨ÙŠÙ‚
â€¢ Ø¨Ø±ÙŠØ¯ Ø¥Ù„ÙƒØªØ±ÙˆÙ†ÙŠ Ø¥Ù„Ù‰ Ø§Ù„Ø¹Ù†ÙˆØ§Ù† Ø§Ù„Ù…Ø³Ø¬Ù„
â€¢ تحديث ØªØ§Ø±ÙŠØ® "Ø¢Ø®Ø± تحديث"
...
''',
                    ...
                    _buildSection(
                      ...
                      content: '''
Ø¥Ø°Ø§ ÙƒØ§Ù† Ù„Ø¯ÙŠÙƒ Ø£ÙŠ Ø£Ø³Ø¦Ù„Ø© Ø­ÙˆÙ„ سياسة الخصوصيةØŒ ÙŠÙ…ÙƒÙ†Ùƒ Ø§Ù„ØªÙˆØ§ØµÙ„ Ù…Ø¹Ù†Ø§:

â€¢ البريد الإلكتروني: privacy@mbuy.app
â€¢ Ø§Ù„Ø¯Ø¹Ù… Ø§Ù„ÙÙ†ÙŠ: support@mbuy.app
â€¢ ÙˆØ§ØªØ³Ø§Ø¨: +966 50 000 0000

Ø³Ù†Ø±Ø¯ Ø¹Ù„Ù‰ Ø§Ø³ØªÙØ³Ø§Ø±Ø§ØªÙƒ Ø®Ù„Ø§Ù„ 48 ساعة Ø¹Ù…Ù„.
''',
                    ),
