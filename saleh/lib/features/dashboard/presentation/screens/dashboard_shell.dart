  ...
  void _onItemTapped(int index, BuildContext context) {
    switch (index) {
      ...
      case 1:
        ...
        break;
      case 2:
        // زر + يفتح صفحة إضافة منتج فقط
        context.go('/dashboard/products/add');
        break;
      case 3:
        context.go('/dashboard/conversations');
        break;
      case 4:
        context.go('/dashboard/shortcuts');
        break;
    }
  }
