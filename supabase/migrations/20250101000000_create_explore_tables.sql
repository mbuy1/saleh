-- ============================================
-- Migration: إنشاء جداول Explore و FCM Tokens
-- التاريخ: 2025-01-01
-- الوصف: إنشاء جداول stories, story_views, story_likes, user_fcm_tokens
-- ============================================
...
-- Indexes لجدول stories (فقط إذا كان الجدول موجوداً)
DO $$ 
BEGIN
